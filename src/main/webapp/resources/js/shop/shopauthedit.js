$(function() {
	...
	// 根据主键获取授权信息的URL
	var infoUrl = '/o2oDemo/shopadmin/getshopauthmapbyid?shopAuthId=' + shopAuthId;
	// 修改授权信息的URL
	var shopAuthPostUrl = '/o2oDemo/shopadmin/modifyshopauthmap';

	if (shopAuthId) {
		getInfo(shopAuthId);
	} else {
		$.toast('用户不存在！');
		window.location.href = '/o2oDemo/shopadmin/shopmanage';
	}
