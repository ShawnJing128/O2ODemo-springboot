$(function() {
	// 列出该店铺下所有授权信息的URL
	var listUrl = '/o2oDemo/shopadmin/listshopauthmapsbyshop?pageIndex=1&pageSize=9999';
	// 修改授权信息的URL
	var modifyUrl = '/o2oDemo/shopadmin/modifyshopauthmap';
	getList();
			...
			.on(
					...
					function(e) {
						...
						if (target.hasClass('edit')) {
							window.location.href = '/o2oDemo/shopadmin/shopauthedit?shopAuthId='
